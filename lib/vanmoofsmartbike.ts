...
import vanmoofsmartcrypto from './vanmoofsmartcrypto';
import { log } from 'console';

export default class vanmoofsmartbike {
    bikeProfile
    cryptService
    encryptionKey
    logger
    ...
    constructor(bikeProfile: string, encryptionKey: string) {
        ...
        this.cryptService = new vanmoofsmartcrypto(
            encryptionKey
        )
...
/*
    async getModuleBattery (bluetoothConnection: any) {
        const modulebattery = await this.readFromBike(bluetoothConnection, '00008a0e00001000800000805f9b34fb', '00002a1900001000800000805f9b34fb');
        const modulebatteryDecrypt = this.cryptService.decrypt(modulebattery)
        console.log('modulebattery', modulebattery)
        console.log('modulebatterycrypt', modulebatteryDecrypt)
        return modulebatteryDecrypt;
    }
*/
