...
class vanMoof extends homey_1.Device {
    ...
    async onInit() {
        ...
        this.vanmoofBikeInstance = new vanmoofbike_1.default(this.getBikeProfile(), store.encryptionKey, store.userKeyId);
    ...
    async handleScanError(error, context) {
    ...
    async scan() {
        ...
        const bike = new vanmoofbike_1.default(this.getBikeProfile(), store.encryptionKey, store.userKeyId);
        this.log('bike', bike);
        /*
    ...
    getBikeProfile() {
        const store = this.getStore();
        const data = this.getData();
        if ((store === null || store === void 0 ? void 0 : store.bleProfile) === 'ELECTRIFIED_2020' || (data === null || data === void 0 ? void 0 : data.bleProfile) === 'ELECTRIFIED_2020') {
            return 'S3';
        }
        if ((store === null || store === void 0 ? void 0 : store.bleProfile) === 'ELECTRIFIED_2019' ||
            (data === null || data === void 0 ? void 0 : data.bleProfile) === 'ELECTRIFIED_2019' ||
            (store === null || store === void 0 ? void 0 : store.bleProfile) === 'ELECTRIFIED_2018' ||
            (data === null || data === void 0 ? void 0 : data.bleProfile) === 'ELECTRIFIED_2018' ||
            (store === null || store === void 0 ? void 0 : store.bikeModel) === 'S2' ||
            (data === null || data === void 0 ? void 0 : data.bikeModel) === 'S2' ||
            (store === null || store === void 0 ? void 0 : store.bikeModel) === 'X2' ||
            (data === null || data === void 0 ? void 0 : data.bikeModel) === 'X2') {
            return 'S2';
        }
        return 'S1';
    }
