...
const vanmoofsmartcrypto_1 = __importDefault(require("./vanmoofsmartcrypto"));
class vanmoofsmartbike {
    constructor(bikeProfile, encryptionKey) {
        this.bikeProfile = bikeProfile;
        this.cryptService = new vanmoofsmartcrypto_1.default(encryptionKey);
...
exports.default = vanmoofsmartbike;
//# sourceMappingURL=vanmoofsmartbike.js.map